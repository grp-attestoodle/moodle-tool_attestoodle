...
function xmldb_block_attestoodle_upgrade($oldversion) {
    ...
    if ($oldversion < 2018062001) {
        ...
        $table->add_key('primary', XMLDB_KEY_PRIMARY, array('id'));
        $table->add_key('fk_category_id', XMLDB_KEY_FOREIGN, array('trainingid'), 'mdl_course_categories', array('id'));
        $table->add_key('fk_user_id', XMLDB_KEY_FOREIGN, array('learnerid'), 'mdl_user', array('id'));
        $table->add_key('fk_launch_id', XMLDB_KEY_FOREIGN, array('launchid'), 'block_attestoodle_launch_log', array('id'));
        ...
        $table->add_key('primary', XMLDB_KEY_PRIMARY, array('id'));
        $table->add_key('fk_certificate_id', XMLDB_KEY_FOREIGN, array('certificateid'), 'block_attestoodle_certif_log', array('id'));
        $table->add_key('fk_module_id', XMLDB_KEY_FOREIGN, array('milestone'), 'mdl_course_modules', array('id'));
